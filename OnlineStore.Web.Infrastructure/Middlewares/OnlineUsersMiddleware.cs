...
public class OnlineUsersMiddleware
{
    ...
    public OnlineUsersMiddleware(RequestDelegate _next,
          string _cookiName = OnlineUsersCookieName, int _lastActivityMinutes = LastActivityBeforeOfflineMinutes)
    {
        next = _next;
        cookieName = _cookiName;
        lastActivityMinutes = _lastActivityMinutes;
    }
